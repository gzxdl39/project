...
<html xmlns="http://www.w3.org/1999/xhtml">
 <head> 
  <link rel="icon" href="/static/images/2222.ico"/>
  <meta charset="utf-8" /> 
  <meta http-equiv="Content-Type" content="text/html; charset=windows-1252" /> 
  <title>@yield('title')</title> 
  <script type="text/javascript" src="/admin/js/libs/jquery-1.8.3.min.js"></script>
  <!-- <link rel="stylesheet" type="text/css" href="/static/css/fangdajing.css"/> -->
 ...
 <body> 
  <div id="wrap"> 
   <div class="header"> 
    <div class="logo">
     <a href="index.html"><img src="/static/images/logo.gif" alt="" title="" border="0" /></a>
    </div> 
    <div id="menu"> 
     <ul> 
